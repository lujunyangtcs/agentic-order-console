...
/** The service desk and the people around it. All fictional. */
export const USERS: User[] = [
  { id: 'U-0412', name: 'Alex Morgan', email: 'alex.morgan@example.com', role: 'CVC User', region: 'ECAN', active: true, mfaEnrolled: true, ticketId: null },
  { id: 'U-0418', name: 'Priya Natarajan', email: 'priya.natarajan@example.com', role: 'CVC User', region: 'ECAN', active: true, mfaEnrolled: true, ticketId: null },
  { id: 'U-0421', name: 'Marc Tremblay', email: 'marc.tremblay@example.com', role: 'CVC User', region: 'ECAN', active: true, mfaEnrolled: true, ticketId: null },
  { id: 'U-0433', name: 'Dana Whitfield', email: 'dana.whitfield@example.com', role: 'CVC User', region: 'WCAN', active: true, mfaEnrolled: true, ticketId: null },
  { id: 'U-0102', name: 'Renée Caron', email: 'renee.caron@example.com', role: 'Administrator', region: 'ALL', active: true, mfaEnrolled: true, ticketId: null },
  { id: 'U-0510', name: 'Owen Hartley', email: 'owen.hartley@example.com', role: 'Other Stakeholder', stakeholderKind: 'sales', region: 'ECAN', active: true, mfaEnrolled: true, ticketId: null },
  { id: 'U-0514', name: 'Sofia Reyes', email: 'sofia.reyes@example.com', role: 'Other Stakeholder', stakeholderKind: 'sales', region: 'WCAN', active: true, mfaEnrolled: true, ticketId: null },
  { id: 'U-0520', name: 'Hugo Lemieux', email: 'hugo.lemieux@example.com', role: 'Other Stakeholder', stakeholderKind: 'planner', region: 'ALL', active: true, mfaEnrolled: true, ticketId: null },
  { id: 'U-0531', name: 'Grace Adeyemi', email: 'grace.adeyemi@example.com', role: 'Other Stakeholder', stakeholderKind: 'dispatcher', region: 'ECAN', active: true, mfaEnrolled: true, ticketId: null },
  { id: 'U-0540', name: 'Ben Kowalczyk', email: 'ben.kowalczyk@example.com', role: 'Other Stakeholder', stakeholderKind: 'shipping_point', region: 'ECAN', active: true, mfaEnrolled: false, ticketId: 'TCK-2' },
  { id: 'U-0544', name: 'Mei-Lin Chow', email: 'mei-lin.chow@example.com', role: 'Other Stakeholder', stakeholderKind: 'shipping_point', region: 'WCAN', active: true, mfaEnrolled: true, ticketId: null },
